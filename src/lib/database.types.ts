...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      profiles: {
        Row: {
          ace_cards_drawn: number
          created_at: string
          current_streak: number
          discoverable: boolean
          full_decks_completed: number
          gender: string | null
          id: string
          is_founding_member: boolean
          joker_cards_drawn: number
          king_cards_drawn: number
      ...
      train_together_session_participants: {
        Row: {
        ...
        Relationships: [
          {
            foreignKeyName: "train_together_session_participants_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "train_together_sessions"
            referencedColumns: ["id"]
          },
        ]
      }
      train_together_sessions: {
        Row: {
          card_count: number
          card_sequence: Json | null
    ...
    Functions: {
      ...
      is_train_together_session_member: {
      ...
      nearby_parks: {
        Args: { in_lat: number; in_lng: number; radius_km?: number }
        Returns: {
          approved: boolean
          created_at: string
          equipment: string[]
      ...
      set_thread_muted: {
        Args: { p_muted: boolean; p_thread_id: string }
        Returns: undefined
      }
      st_3dclosestpoint: {
        Args: { geom1: unknown; geom2: unknown }
